...
export PATH="/home/app/asset-sniper/bin:$HOME/.krew/bin:./bin:$HOME/bin:$GOPATH/bin:$PATH"
export HISTFILE="/home/app/asset-sniper/.zsh_history"
...
set -a
source /home/app/asset-sniper/.env.vars
set +a

echo "*" > /home/app/asset-sniper/tmp/.gitignore
echo "!.gitignore" >> /home/app/asset-sniper/tmp/.gitignore
